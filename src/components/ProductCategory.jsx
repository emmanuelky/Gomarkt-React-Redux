...
const ProductCategory = () => {
    return (<>
        ...
        <div className='flex flex-wrap justify-evenly'>
            ...
            <div className='border-b-2 border-t-2 p-5  border-yellow-400 hover:border-yellow-600 hover:bg-yellow-300 cursor-pointer'>
            ...
            </div>  <div className='border-b-2 border-t-2 p-5  border-yellow-400 hover:border-yellow-600 hover:bg-yellow-300 cursor-pointer'>
